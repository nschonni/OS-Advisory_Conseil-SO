...
Finally, Marc asked about secure development.  From the [question](../Rencontres/2018-03-15.md) section "Concerning Github, what security measures are in place to prevent mistakes? Two controls: no one can delete and there is a backup in cloud. Many controls like fork and branch to review the code before publishing it."
